        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {appointments.map((appointment) => (
              <div
                key={appointment._id}
                className={`bg-white rounded-xl shadow-md overflow-hidden ${appointment.cancelled
                ...
                <div className="p-6 md:flex md:space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium ${appointment.cancelled
