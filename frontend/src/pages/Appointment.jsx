...
const Appointment = () => {
  ...
  const getAvailableSlot = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      endTime.setDate(today.getDate() + i); // date will be today to 7 day date show
      endTime.setHours(19, 0, 0, 0); //for end time like 7pm will be end for booking hour
  ...
  const handleBookAppointment = () => {
    ...
    setTimeout(() => {
      alert(`Appointment booked for ${docSlots[selectedDateIndex].date.toDateString()} at ${selectedTime}`);
      setIsBooking(false);
    }, 1500);
  };
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <Link to="/doctors" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Doctors</Link>
              </div>
            </li>
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">Appointment</span>
              </div>
            </li>
          </ol>
        </nav>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <div className="p-6">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 text-center">{docInfo.name}</h2>
                  <p className="text-blue-600 font-medium text-center">{docInfo.speciality}</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-2xl font-bold text-green-600">{currencySymbol}{docInfo.fees}</span>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                    <img src={assets.info_icon} alt="Info" className="w-5 h-5 mr-2" />
                    About {docInfo.name}
                  </h3>
          ...
          <div className="w-full lg:w-3/5">
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">Select an available time slot for your consultation</p>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {docSlots.map((day, index) => (
                      ...
                      >
                        <span className="text-sm font-medium">{shortDays[day.date.getDay()]}</span>
                        <span className="text-lg font-bold">{day.date.getDate()}</span>
                        <span className="text-xs">{months[day.date.getMonth()]}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">
                    Available Time Slots for {daysOfWeek[docSlots[selectedDateIndex]?.date.getDay()]}, {docSlots[selectedDateIndex]?.date.getDate()} {months[docSlots[selectedDateIndex]?.date.getMonth()]}
                  </h3>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {docSlots[selectedDateIndex]?.slots.map((slot, index) => (
                      <button
                        ...
                        className={`py-2 px-4 rounded-md text-center transition-colors ${selectedTime === slot.time
                          ? 'bg-blue-600 text-white'
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium">
                          {daysOfWeek[docSlots[selectedDateIndex].date.getDay()]}, {docSlots[selectedDateIndex].date.getDate()} {months[docSlots[selectedDateIndex].date.getMonth()]}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Time</p>
                        <p className="font-medium">{selectedTime.toLowerCase()}</p>
                      </div>
                      <div>
